...
ControlView = UserView.extend({
	...
	render: function(){
		...
		$("#control-dialog").dialog({
			...
			create: function(ev, ui){
				...
				$("a.ui-dialog-titlebar-close", b).remove()//去掉删除按钮
			}
		});
	...
	onSaveLinkClicked: function(e){
		var self = this;
		this._toggleActiveStyle(e.currentTarget),
		this.getContainer().saveApp(function(){
			self.refrash()
		})
	},
	onPublishLinkClicked: function(e){
		var self = this;
		this._toggleActiveStyle(e.currentTarget),
		this.getContainer().publishApp(function(){
			self.refrash()
		})
	},
	...
	_changeDesignMode: function(a){
		this.getContainer().changeDesignMode(a)
	},
	refrash: function(){
...
DeviceView = UserView.extend({
	...
	initialize: function(){
		...
		// UserView.prototype.setContainer(window.App),
		// this.initEvents()
	},
	initEvents: function(){
		// var self = this;
